...
int sensorLeft = A1; //input from analog left proximity sensor.
int sensorRight = A0;//input from analog right proximity sensor.
double sensorOutOne = D1;//output from left sensor to the photon.
double sensorOutTwo = D0;//output from right sensor to the photon.
...
void loop()
{
    dataValOne = analogRead (sensorOutOne);//output analog pin read for left sensor.
    dataValTwo = analogRead (sensorOutTwo);//output analog pin read for right sensor.
